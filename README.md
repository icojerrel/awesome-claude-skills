...
- [Skill Orchestrator](./skill-orchestrator/) - **🆕 NEW ⭐ META-SKILL** Intelligent skills management system that maintains awareness of all available skills, periodically scans GitHub for valuable new skills, and automatically assigns optimal skills to fulfill tasks. Features task-to-skill matching, workflow automation, quality assessment, and GitHub ecosystem scanning.
