...
- [API Fixer](./api-fixer/) - Diagnose and fix API issues including endpoint bugs, response problems, integration failures, code quality improvements, and schema/contract errors.
